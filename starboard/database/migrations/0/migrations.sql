...
ALTER TABLE sb_messages ADD COLUMN orig_message_id NUMERIC;
...
ALTER TABLE sb_messages ALTER COLUMN orig_message_id SET NOT NULL;
...
ALTER TABLE aschannels ADD CONSTRAINT _aschannels_channel_id_primary_key PRIMARY KEY ( channel_id );
...
ALTER TABLE sb_messages ADD CONSTRAINT _sb_messages_message_id_primary_key PRIMARY KEY ( message_id );
ALTER TABLE starboards ADD CONSTRAINT _starboards_channel_id_primary_key PRIMARY KEY ( channel_id );
...
ALTER TABLE autoredeems ADD CONSTRAINT guildid_fk FOREIGN KEY ( guild_id ) REFERENCES guilds ( guild_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE autoredeems ADD CONSTRAINT userid_fk FOREIGN KEY ( user_id ) REFERENCES users ( user_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE permgroups ADD CONSTRAINT guild_id_fk FOREIGN KEY ( guild_id ) REFERENCES guilds ( guild_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE sb_messages ADD CONSTRAINT orig_message_id_fk FOREIGN KEY ( orig_message_id ) REFERENCES messages ( message_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE sb_messages ADD CONSTRAINT starboard_id_fk FOREIGN KEY ( starboard_id ) REFERENCES starboards ( channel_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE stars ADD CONSTRAINT message_id_fk FOREIGN KEY ( message_id ) REFERENCES messages ( message_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE stars ADD CONSTRAINT starboard_id_fk FOREIGN KEY ( starboard_id ) REFERENCES starboards ( channel_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE stars ADD CONSTRAINT user_id_fk FOREIGN KEY ( user_id ) REFERENCES users ( user_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
