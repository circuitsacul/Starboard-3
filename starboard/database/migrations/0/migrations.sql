...
ALTER TABLE users ADD COLUMN credits_recv INTEGER;
...
ALTER TABLE aschannels ALTER COLUMN max_chars SET NOT NULL;
...
ALTER TABLE users ALTER COLUMN credits_recv SET NOT NULL;
