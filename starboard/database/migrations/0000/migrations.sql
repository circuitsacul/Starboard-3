...
ALTER TABLE upvotes ADD COLUMN message_id NUMERIC;
ALTER TABLE upvotes ADD COLUMN starboard_id NUMERIC;
ALTER TABLE upvotes ADD COLUMN user_id NUMERIC;
ALTER TABLE upvotes ADD COLUMN target_author_id NUMERIC;
...
ALTER TABLE upvotes ALTER COLUMN message_id SET NOT NULL;
ALTER TABLE upvotes ALTER COLUMN starboard_id SET NOT NULL;
ALTER TABLE upvotes ALTER COLUMN user_id SET NOT NULL;
ALTER TABLE upvotes ALTER COLUMN target_author_id SET NOT NULL;
...
CREATE INDEX _hash_index_upvotes__starboard_id ON upvotes USING HASH ( ( starboard_id ) );
CREATE INDEX _hash_index_upvotes__user_id ON upvotes USING HASH ( ( user_id ) );
CREATE INDEX _hash_index_upvotes__message_id ON upvotes USING HASH ( ( message_id ) );
CREATE INDEX _hash_index_upvotes__target_author_id ON upvotes USING HASH ( ( target_author_id ) );
...
ALTER TABLE upvotes ADD CONSTRAINT _upvotes_message_id_starboard_id_user_id_primary_key PRIMARY KEY ( message_id , starboard_id , user_id );
...
ALTER TABLE upvotes ADD CONSTRAINT message_id_fk FOREIGN KEY ( message_id ) REFERENCES messages ( id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE upvotes ADD CONSTRAINT starboard_id_fk FOREIGN KEY ( starboard_id ) REFERENCES starboards ( id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE upvotes ADD CONSTRAINT user_id_fk FOREIGN KEY ( user_id ) REFERENCES users ( id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
ALTER TABLE upvotes ADD CONSTRAINT target_author_id_fk FOREIGN KEY ( target_author_id ) REFERENCES users ( id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;