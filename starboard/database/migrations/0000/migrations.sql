...
ALTER TABLE overrides ADD CONSTRAINT starboard_fk FOREIGN KEY ( starboard_id ) REFERENCES starboards ( channel_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE permrole_starboards ADD CONSTRAINT starboard_id_fk FOREIGN KEY ( starboard_id ) REFERENCES starboards ( channel_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE votes ADD CONSTRAINT starboard_id_fk FOREIGN KEY ( starboard_id ) REFERENCES starboards ( channel_id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;
