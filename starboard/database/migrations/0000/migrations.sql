...
CREATE INDEX _hash_index_aschannels__channel_id ON aschannels USING HASH ( ( channel_id ) );
CREATE INDEX _hash_index_aschannels__guild_id ON aschannels USING HASH ( ( guild_id ) );
CREATE INDEX _hash_index_aschannels__name ON aschannels USING HASH ( ( name ) );
...
CREATE INDEX _hash_index_starboards__channel_id ON starboards USING HASH ( ( channel_id ) );
...
CREATE INDEX _hash_index_starboards__name ON starboards USING HASH ( ( name ) );
