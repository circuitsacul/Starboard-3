...
ALTER TABLE stars ADD COLUMN target_author_id NUMERIC;
...
ALTER TABLE stars ALTER COLUMN target_author_id SET NOT NULL;
...
CREATE INDEX _hash_index_stars__target_author_id ON stars USING HASH ( ( target_author_id ) );
...
ALTER TABLE stars ADD CONSTRAINT target_author_id_fk FOREIGN KEY ( target_author_id ) REFERENCES users ( id ) MATCH SIMPLE ON DELETE CASCADE ON UPDATE CASCADE;